...
class Mensalidade extends Model
{
    ...
    public function consultaMensalidade()
    {   

        $stringQuery = "SELECT DISTINCT  m.*, u.name from mensalidade m, users u  where m.excluidomensalidade = 0 AND u.id = m.id_ult_alterador";
