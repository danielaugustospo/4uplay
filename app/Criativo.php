...
class Criativo extends Model
{
    ...
    {   
        ...
        $stringQuery = "SELECT cri.*, u.name  as 'licenciado', cli.c_nome as 'cliente' 
                        FROM criativo cri
    ...
    public function insereHistorico($dadosrequisicao, $idlicenciado, $nomeCliente, $tipo)
    {
        if ($tipo == 1){
            ...
            VALUES(NULL, '".$dadosrequisicao[0]->id."', '".$nomeCliente."', '".$dadosrequisicao[0]->tipocriativo."', '".$dadosrequisicao[0]->quantidade."', '".$dadosrequisicao[0]->valunit."', '".$dadosrequisicao[0]->valtotal."', '".$tipooperacao."', '".$idlicenciado."', '".$idlicenciado."', '".$dadosrequisicao[0]->created_at."', '".$dadosrequisicao[0]->updated_at."')";
        ...
        if($tipo == 2){
            ...
            VALUES(NULL, '".$dadosrequisicao[0]->id."', '".$nomeCliente."', '".$dadosrequisicao[0]->tipocriativo."', '".$dadosrequisicao[0]->quantidade."', '".$dadosrequisicao[0]->valunit."', '".$dadosrequisicao[0]->valtotal."', '".$tipooperacao."', '".$idlicenciado."', '".$idlicenciado."', '".$dataoperacao."')";
        ...
        if($tipo == 3){
            ...
            $stringQuery = "INSERT INTO historicocriativo
            (hc_id, hc_idcriativo, hc_cliente, hc_tipocriativo, hc_quantidade, hc_valunit, hc_valtotal, hc_tipooperacao, hc_idlicenciado, hc_id_ult_alterador, hc_dataalteracao)
            VALUES(NULL, '".$dadosrequisicao->id."', '".$nomeCliente."', '".$dadosrequisicao->tipocriativo."', '".$dadosrequisicao->quantidade."', '".$dadosrequisicao->valunit."', '".$dadosrequisicao->valtotal."', '".$tipooperacao."', '".$dadosrequisicao->idlicenciado."', '".$dadosrequisicao->id_ult_alterador."', '".$dataoperacao."')";
